...
namespace Bam.Encryption
{
    public class Arguments : CommandLineTool
    {
        ...
        {
            AddValidArgument("subjectName", false, false, GetDescription(nameof(CertificateAuthorityConsoleActions.GenerateSelfSignedCertificate), "the subject name used for the certificate"));
            AddValidArgument("validForYears", false, false, GetDescription(nameof(CertificateAuthorityConsoleActions.GenerateSelfSignedCertificate), "the number of years the certificate is valid for"));
            AddValidArgument("signatureAlgorithm", false, false, GetDescription(nameof(CertificateAuthorityConsoleActions.GenerateSelfSignedCertificate), "the signature algorithm to use"));
